...
public class TableRow2 {
    ...
    public TableRow2 (String user_name, String sell_name, String trade_time, String from_address,int trade_num, String trade_goods_name, String trade_addition, boolean Ifcheck) {
